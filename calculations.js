...
$('.shielding > article').on('click','div > .lens',function() {
  ...
  if ((selection.fixture.split('').reverse()[0] !== 'B' && selection.fixture !== "CDS" && selection.fixture.includes('D/I') === false) || Number($(this).attr('id').split('_')[1]) > 0) {
    if (hemiLabel === 'direct') {
      $('.indirect').hide();
    }
